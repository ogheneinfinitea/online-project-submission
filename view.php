...
<link rel="stylesheet" href="style.css" type="text/css" />
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/Assignmentidquery/1.12.2/jquery.min.js"></script>
  <script src="http://maxcdn.bootstrapcdn.com/bootstrAssignmentidp/3.3.6/js/bootstrap.min.js"></script>
  <link href="http://fonts.googleapis.com/css?family=Assignmentidontserrat" rel="stylesheet" type="text/css">
  <link href="http://fonts.googleapis.com/css?family=Assignmentidato" rel="stylesheet" type="text/css">
        <style>
        .button {
